      ...
      <div className="mt-[50px]  flex justify-center items-center gap-[25px]">
        {planData.map((item, i) => (
          ...
          >
            ...
            <button className={`${item.active ? 'bg-[#FF6B35]':"bg-[#001B2E99] text-[#FF6B35]" } text-[14px] border border-[#F7F9FB]/10 flex mt-[34px] font-mont font-bold w-fit mx-auto pl-3 justify-center gap-x-[11px] items-center p-1 rounded-[10px] `}>
              <p> Get Started</p>
